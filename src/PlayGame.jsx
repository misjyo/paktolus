...
export default function PlayGame({ setPlay, islogin, user, setUser }) {
  ...
  const [message, setMessage] = useState("Play with casino ...");
  ...
  const spinHandler = () => {
    ...
    if (!isloading) {
      ...
      if (randno[0] === "3" && randno[1] === "3" && randno[2] === "3") {
        ...
        setMessage("Congratulations you won 5$ ");
        result = "5";
      } else {
        if (randno[0] === randno[1] && randno[1] === randno[2]) {
          ...
          if (
            ...
            setMessage("Congratulations you won 0.5$ ");
            result = "0.5";
          } else {
  ...
  return (
    ...
    >
      <Card
        style={{
          backgroundImage: "linear-gradient(180deg, black,#79a5ed, black)",
        ...
        <div>
          <Space>
            <Spin spinning={isloading} size="small">
              <PlayingCard option={random_no[0]} size="small" />
            </Spin>
            <Spin spinning={isloading}>
              <PlayingCard option={random_no[1]} size="small" />
            </Spin>
            <Spin spinning={isloading}>
              <PlayingCard option={random_no[2]} size="small" />
            </Spin>
          </Space>
